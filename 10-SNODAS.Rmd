...
SNODAS data is available from the [web page](https://nsidc.org/data/g02158), 
...
A simple method is available for accessing SNODAS in R, dependent on the 
NCAR/rwrfhydro library. This is demonstrated in the code exaple below.


## SNODAS Code example

***Getting SWE and Snow Depth***
