...
2. From “Open Research” tab, click the link to the data.

3. Select the data type you want to download and click “download” on the far right. 

4. Open the zip folder and move the file of the year you are interested in to the same directory as your Rproject. 
...
7. The units can be viewed by ```nc$var$[VARIABLE_NAME]$units``` or opening nc in the viewer.
