...
This user's guide facilitates accessing the microclimate datasets in the table below. We detail the horizontal, vertical, and temporal coverage. Our complementary [R shiny application](https://map.trenchproject.com/RShiny_Microclim/) allows comparing each methods both temporally and spatially to help select a dataset that best meets your needs.
