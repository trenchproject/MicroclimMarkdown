...
This [R shiny](https://map.trenchproject.com/RShiny_Microclim/) will be a good platform to compare each methods both temporally and spatially to help decide what methods best fit your needs.

Here is a table of each method listing their coverage and variables.
