---
pagetitle: NicheMapR + microclima
---
...
1. Install the RNCEP, elevatr, NicheMapR, and microclima packages.
...
4. Run `micro_ncep()` with the above variables. Variables are stored under different categories depending on what you are looking for. `?micro_ncep` will give you a list of what each category includes and how each variable is named. 
