...
3. Go to [this page](https://disc.gsfc.nasa.gov/datasets/GLDAS_NOAH025_3H_2.1/summary?keywords=GLDAS) and hit **Subset/Get Data**.

4. Under the Download Method, select **Get File Subsets using the GES DISC Subsetter**.

5. Refine date range and region and select the variables to download. Keep file format as **netCDF**.

6. Hit **Get data**.

7. On the pop-up window, hit **Download links list**.
